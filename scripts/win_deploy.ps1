...
Write-Host "--- LLM Orchestrator Windows Deploy v5.1 ---" -ForegroundColor Cyan

# 1. Срочная установка aria2 (без неё 5.5ГБ не выкачать стабильно)
if (!(Get-Command aria2c -ErrorAction SilentlyContinue)) {
    Write-Host "[1/4] Installing aria2..." -ForegroundColor Yellow
...
# Кэш q4_0 сжимает контекст в 4 раза. 16к контекста займут всего 500-600МБ.
$kv_type = "fp16"
