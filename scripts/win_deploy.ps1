...
Write-Host "--- LLM Orchestrator v6.3 (RTX 5060 Optimized) ---" -ForegroundColor Cyan
...
# 2. BITS Downloader (Directly to file, avoids memory issues)
...
# 4. 8GB VRAM Optimization (RTX 5060)
