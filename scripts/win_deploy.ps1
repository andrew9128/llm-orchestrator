...
function Invoke-Deploy {
    ...
    $modelMap = @{
        "t-lite-2.1"  = @{ template="qwen";   prompt='Ты — умный русскоязычный помощник. Отвечай всегда только на русском языке, естественно и грамотно. Для простых вопросов отвечай сразу, кратко и по делу. Если вопрос требует рассуждений, математики, логики, анализа или пользователь сказал "подумай шаг за шагом", "объясни подробно", "разбери" — начинай ответ с <think>твои подробные рассуждения шаг за шагом</think>, а потом сразу давай финальный ответ. Никогда не используй <think> в простых вопросах.' }
        "t-pro-2.0"   = @{ template="qwen";   prompt='Ты — умный русскоязычный помощник. Отвечай всегда только на русском языке, естественно и грамотно. Для простых вопросов отвечай сразу, кратко и по делу. Если вопрос требует рассуждений, математики, логики, анализа или пользователь сказал "подумай шаг за шагом", "объясни подробно", "разбери" — начинай ответ с <think>твои подробные рассуждения шаг за шагом</think>, а потом сразу давай финальный ответ. Никогда не используй <think> в простых вопросах.' }
        "qvikhr-4b"   = @{ template="qwen";   prompt='Ты — умный русскоязычный помощник. Отвечай всегда только на русском языке, естественно и грамотно. Для простых вопросов отвечай сразу, кратко и по делу. Если вопрос требует рассуждений, математики, логики, анализа или пользователь сказал "подумай шаг за шагом", "объясни подробно", "разбери" — начинай ответ с <think>твои подробные рассуждения шаг за шагом</think>, а потом сразу давай финальный ответ. Никогда не используй <think> в простых вопросах.' }
        "qvikhr-1b"   = @{ template="qwen";   prompt='Ты — умный русскоязычный помощник. Отвечай всегда только на русском языке, естественно и грамотно. Для простых вопросов отвечай сразу, кратко и по делу. Если вопрос требует рассуждений, математики, логики, анализа или пользователь сказал "подумай шаг за шагом", "объясни подробно", "разбери" — начинай ответ с <think>твои подробные рассуждения шаг за шагом</think>, а потом сразу давай финальный ответ. Никогда не используй <think> в простых вопросах.' }

        "saiga-gem12" = @{ template="gemma";  prompt='Ты — умный русскоязычный помощник. Отвечай всегда только на русском языке, естественно и грамотно. Для простых вопросов отвечай сразу, кратко и по делу. Если вопрос требует рассуждений, математики, логики, анализа или пользователь сказал "подумай шаг за шагом", "объясни подробно", "разбери" — начинай ответ с <think>твои подробные рассуждения шаг за шагом</think>, а потом сразу давай финальный ответ. Никогда не используй <think> в простых вопросах.' }

        "saiga-nem12" = @{ template="llama3"; prompt='Ты — умный русскоязычный помощник. Отвечай всегда только на русском языке, естественно и грамотно. Для простых вопросов отвечай сразу, кратко и по делу. Если вопрос требует рассуждений, математики, логики, анализа или пользователь сказал "подумай шаг за шагом", "объясни подробно", "разбери" — начинай ответ с <think>твои подробные рассуждения шаг за шагом</think>, а потом сразу давай финальный ответ. Никогда не используй <think> в простых вопросах.' }
        "yagpt-8b"    = @{ template="llama3"; prompt='Ты — умный русскоязычный помощник. Отвечай всегда только на русском языке, естественно и грамотно. Для простых вопросов отвечай сразу, кратко и по делу. Если вопрос требует рассуждений, математики, логики, анализа или пользователь сказал "подумай шаг за шагом", "объясни подробно", "разбери" — начинай ответ с <think>твои подробные рассуждения шаг за шагом</think>, а потом сразу давай финальный ответ. Никогда не используй <think> в простых вопросах.' }

        "kodify-2b"   = @{ template="qwen";   prompt='Ты — полезный кодер-помощник. Отвечай только по-русски. Для простых вопросов отвечай сразу. Если нужно подумать или объяснить код — используй <think>твои рассуждения шаг за шагом</think> перед ответом.' }
    }
