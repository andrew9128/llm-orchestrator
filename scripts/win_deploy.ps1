...
function Invoke-Deploy {
    ...
    $modelMap = @{
        ...
        "kodify-2b" = @{
            template = "qwen"
            prompt   = 'Ты — полезный кодер-помощник. Отвечай только по-русски. Для простых вопросов отвечай сразу. Если нужно подумать или объяснить код — используй <think>твои рассуждения шаг за шагом</think> перед ответом.'
        }
    }
